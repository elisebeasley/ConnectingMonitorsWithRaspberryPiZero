...
https://github.com/raspberrypilearning/networking-lessons/blob/master/lesson-1/code/network.py
https://github.com/raspberrypilearning/networking-lessons/blob/master/lesson-1/worksheet.md
https://github.com/rusk-yhs/SocketExample/blob/master/chatter.py
https://github.com/raspberrypilearning/networking-lessons/blob/master/lesson-1/worksheet.md

Sources listed above. This code has 2 pis talk to each other via wifi network.

https://www.w3schools.com/python/python_try_except.asp
https://www.geeksforgeeks.org/python-program-that-sends-and-recieves-message-from-client/
https://realpython.com/python-sockets/

Sources listed above were used to understand the commands and functions of this code.
"""
...
class Connection():
    ...
    def call(self, addr, whenHearCall, port=None):
        ...
        self.connected = True
        self.threadHandle = _startListenerThread(self.peerHandle, addr, whenHearCall, self.whenHungupHandler,
                                                 self.endOfPacket)
